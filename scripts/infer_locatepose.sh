...
# POSE_ROI_SIZE：每个人体框 ROI 特征采样边长；越大越耗显存。
...
LOCATE_BOX_MAX_NEW_TOKENS="${LOCATE_BOX_MAX_NEW_TOKENS:-16000}"
# BOX_NMS_IOU_THRESH：生成框 NMS 阈值；越小去重越强。
BOX_NMS_IOU_THRESH="${BOX_NMS_IOU_THRESH:-0.95}"
